...
<Project Type="Project" LVVersion="24008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="CML Message Queue.lvlib" Type="Library" URL="../support/Message Queue/CML Message Queue.lvlib"/>
			<Item Name="CML User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/CML User Event - Stop.lvlib"/>
			<Item Name="CML Set Enable State on Multiple Controls.vi" Type="VI" URL="../support/CML Set Enable State on Multiple Controls.vi"/>
			<Item Name="CML Check Loop Error.vi" Type="VI" URL="../support/CML Check Loop Error.vi"/>
			<Item Name="CML Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/CML Error Handler - Event Handling Loop.vi"/>
			<Item Name="CML Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/CML Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="CML Acquired Data.ctl" Type="VI" URL="../controls/CML Acquired Data.ctl"/>
			<Item Name="CML UI Data.ctl" Type="VI" URL="../controls/CML UI Data.ctl"/>
			<Item Name="CML UI State.ctl" Type="VI" URL="../controls/CML UI State.ctl"/>
		</Item>
		<Item Name="CML Acquisition.lvlib" Type="Library" URL="../Acquisition/CML Acquisition.lvlib"/>
		<Item Name="CML Logging.lvlib" Type="Library" URL="../Logging/CML Logging.lvlib"/>
		<Item Name="CML Settings.lvlib" Type="Library" URL="../Settings/CML Settings.lvlib"/>
